...
const DOMAIN_MAPPINGS: {
  ...
  },
  {
    ...
    keywords: ["appliance", "iron", "geyser", "water heater", "mixer", "blender", "grinder", "room heater", "immersion rod", "fan", "ceiling fan"],
  ...
  },
  {
    ...
    keywords: ["cable", "wire", "copper wire", "building wire", "xlpe", "armoured cable", "ht cable", "conductor"],
  ...
  },
  {
    ...
    keywords: ["led", "led bulb", "led driver", "street light", "luminaire", "batten light", "smps"],
  ...
  },
  {
    ...
    keywords: ["lithium", "battery", "power bank", "ev battery", "cell", "laptop", "computer", "smart meter", "solar inverter"],
  ...
  },
  {
    ...
    keywords: ["pipe", "hdpe", "upvc", "cpvc", "pvc pipe", "plumbing pipe", "water pipe", "swr", "drainage"],
  ...
  },
  {
    ...
    keywords: ["steel", "tmt", "rebar", "reinforcement", "cement", "opc", "ppc", "structural steel", "i beam"],
  ...
  },
  {
    ...
    keywords: ["toy", "toys", "baby product", "shoe", "footwear", "sneaker", "packaged water", "water bottle", "drinking water", "helmet", "insulating mat"],
