...
ACTIVE_STANDARDS.append(std("is-17526-2021", "IS 17526:2021", "Stainless Steel Vacuum Flasks and Insulated Containers — Specification", 2021,
    ...
    [
        cls("is17526-c1", "Clause 1", "Scope & Product Applicability", "This standard prescribes the requirements, construction, thermal insulation performance, and methods of sampling and test for stainless steel double-walled vacuum flasks and insulated containers of capacity up to 10 litres intended for domestic, institutional, and outdoor conveyance of potable liquids."),
        cls("is17526-c2", "Clause 2", "Normative References", "The standards listed (IS 6911 for stainless steel sheets, IS 9845 for plastic migration testing, IS 10910 for polypropylene contact, IS 4905 for random sampling) contain provisions which constitute essential requirements of this standard."),
        cls("is17526-c3", "Clause 3", "Terminology & Constructional Design", "A double-walled insulated container comprises an inner fluid vessel and an outer protective shell separated by an evacuated interstitial space with high vacuum (< 10^-4 mbar) sealed by brazing or welding. An effective closure device with food-grade elastomer seal prevents fluid leakage."),
        cls("is17526-c4", "Clause 4", "Nominal Capacity & Tolerances (Table 1)", "The actual liquid capacity when filled to within 12 mm from the top of the neck shall not deviate from the marked nominal capacity by more than +/- 5% for capacities up to 1000 ml (+/- 3% for above 1000 ml). Minimum thickness of inner wall shall be 0.40 mm.", table_data={"headers": ["Nominal Capacity (ml)", "Min Wall Thickness (mm)", "Tolerance on Volume", "Max Outer Diameter (mm)"], "rows": [["350 ml", "0.40 mm", "± 5.0%", "72 mm"], ["500 ml", "0.40 mm", "± 5.0%", "76 mm"], ["750 ml", "0.40 mm", "± 5.0%", "82 mm"], ["1000 ml", "0.45 mm", "± 5.0%", "88 mm"], ["1500 ml", "0.50 mm", "± 3.0%", "105 mm"]]}),
        cls("is17526-c5", "Clause 5.1", "Material Chemical Composition (Table 2)", "The inner vessel in direct contact with beverages shall be manufactured from austenitic stainless steel Grade 304 (X04Cr19Ni9) or Grade 316 conforming to IS 6911. Scrap or radioactive steel is strictly prohibited.", "XRF or OES chemical analysis for Nickel (min 8.0%) and Chromium (min 17.5%).", table_data={"headers": ["Element", "Grade 304 Requirement (%)", "Grade 316 Requirement (%)", "Test Method"], "rows": [["Chromium (Cr)", "17.50% - 19.50%", "16.00% - 18.00%", "XRF / OES Spectrometry"], ["Nickel (Ni)", "8.00% - 10.50%", "10.00% - 14.00%", "XRF / OES Spectrometry"], ["Carbon (C)", "≤ 0.07% max", "≤ 0.07% max", "Combustion Analyzer"], ["Manganese (Mn)", "≤ 2.00% max", "≤ 2.00% max", "Spectrometry"], ["Molybdenum (Mo)", "Not required", "2.00% - 3.00%", "Spectrometry"]]}),
        cls("is17526-c6", "Clause 6", "Surface Finish, Welds & Acid Passivation", "Internal surfaces of the inner container shall be smoothly finished, electropolished, and free from cracks, burrs, oxide scales, or deep weld pits. All inner seams shall be passivated with nitric/citric acid bath to ensure no rust or heavy metal leaches into potable liquids."),
        cls("is17526-c7", "Clause 7.2", "Thermal Insulation Retention Performance (Table 3)", "When filled with boiling potable water at 95°C and sealed in an ambient environment maintained at 20°C +/- 2°C, the water temperature inside the container shall remain >= 60°C after 6 hours (and >= 45°C after 24 hours). For cold retention, water filled at 4°C shall remain <= 10°C after 6 hours.", "Calibrated multi-channel thermocouple datalogger test per Section 7.", table_data={"headers": ["Container Type", "Initial Temp (°C)", "Ambient Temp (°C)", "Min Temp after 6h (°C)", "Min Temp after 24h (°C)"], "rows": [["Double-Walled Vacuum (≤ 500 ml)", "95°C ± 1°C", "20°C ± 2°C", "≥ 58°C", "≥ 42°C"], ["Double-Walled Vacuum (750 - 1000 ml)", "95°C ± 1°C", "20°C ± 2°C", "≥ 62°C", "≥ 48°C"], ["Double-Walled Vacuum (> 1000 ml)", "95°C ± 1°C", "20°C ± 2°C", "≥ 66°C", "≥ 52°C"]]}),
        cls("is17526-c8", "Clause 8.1", "Gasket Sealing & Inversion Hydrostatic Leak Test", "The bottle closure gasket shall be made of food-grade silicone conforming to IS 9845. When filled to nominal capacity with hot water at 80°C and inverted upside-down for 10 continuous minutes, the closure shall show ZERO droplets, moisture seepage, or pressure loss.", "Inversion hydrostatic seal test at 80°C under 1000 lux inspection."),
        cls("is17526-c9", "Clause 9.3", "Mechanical Drop Impact & Handle Attachment Test", "The container filled to nominal capacity with water at room temperature shall be dropped freely from a height of 1.0 m onto a rigid flat concrete anvil. After impact, there shall be no fracture, leakage, or loss of vacuum insulation. Handles shall withstand 20 kg static tensile pull for 5 minutes.", "Guided 1.0-metre drop tester and tensile handle pull rig."),
        cls("is17526-c10", "Clause 10", "Sampling, Batch Criteria & Scheme of Testing (STI)", "Sampling shall be carried out in accordance with IS 4905. For daily factory batch testing under the BIS STI, routine tests (visual, capacity, leak test, thermal check) shall be conducted on 1 in every 500 units produced. Routine records must be preserved for 3 years."),
        cls("is17526-c11", "Clause 11", "Mandatory Marking, Laser Embossing & Labelling", "Each container shall be permanently laser-engraved or embossed with: (a) BIS Standard Mark (ISI Logo) with License Number CM/L-XXXXXXXXXX, (b) Nominal capacity in ml, (c) Food Grade SS 304 mark, (d) Manufacturer name/trademark, (e) Month and Year of manufacture, and (f) Batch/Lot code.")
    ],
